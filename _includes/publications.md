...
<div class="experience-section" style="margin-bottom: 2em;">
  <div style="margin-bottom: 1.2em; display: flex; align-items: flex-start; gap: 18px;">
    <img src="./assets/img/add2cart page2.png" alt="HackPPMK25" style="width: 90px; height: 90px; object-fit: cover; border-radius: 10px; box-shadow: 0 2px 8px rgba(0,0,0,0.07);">
    <div>
  ...
  <div style="margin-bottom: 1.2em; display: flex; align-items: flex-start; gap: 18px;">
    <img src="./assets/img/photo_6282947558577474450_y.jpg" alt="YISS" style="width: 90px; height: 90px; object-fit: cover; border-radius: 10px; box-shadow: 0 2px 8px rgba(0,0,0,0.07);">
    <div>
  ...
  <div style="margin-bottom: 1.2em; display: flex; align-items: flex-start; gap: 18px;">
    <img src="./assets/img/photo_6282947558577474413_x.jpg" alt="Base Initiative" style="width: 90px; height: 90px; object-fit: cover; border-radius: 10px; box-shadow: 0 2px 8px rgba(0,0,0,0.07);">
    <div>
  ...
  <div style="margin-bottom: 1.2em; display: flex; align-items: flex-start; gap: 18px;">
    <img src="./assets/img/photo_6282947558577474416_x.jpg" alt="MCC" style="width: 90px; height: 90px; object-fit: cover; border-radius: 10px; box-shadow: 0 2px 8px rgba(0,0,0,0.07);">
    <div>
